...
import { nftUnStake, stakeNft } from "./api/stake";
...
(async () => {
  ...
  // const r1 = await createTokenMintAccount(defaultWallet);
  // console.log(r1);

  // const r2 = await nftMint(defaultWallet, "nft_1");
  // console.log(r2);


  // const r3 = await stakeNft(defaultWallet, "nft_1");
  // console.log(r3);

  const r3 = await nftUnStake(defaultWallet, "nft_1");
  console.log(r3);
})()